...
namespace Microsoft.Azure.Management.Media.Models
{
    ...
    public partial class TrackedResource : Resource
    {
        ...
        /// </param>
        public TrackedResource(string location, System.Collections.Generic.IDictionary<string, string> tags, string id = default(string), string name = default(string), string type = default(string))
